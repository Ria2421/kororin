...
public class dragAndDrop : MonoBehaviour
{
    ...
    public void OnMouseDrag()
    {
        ...
        hang.GetComponent<Rigidbody>().linearVelocity = (GetActiveZoneIntersection(dragHeight, Camera.main) + mOffset - hang.transform.position) * 10;
    ...
    {
        hang.GetComponent<Rigidbody>().linearVelocity = Vector3.zero;
